  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f7faf7] relative">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md flex flex-col items-center">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-1 text-center">Student Registration</h2>
        <p className="text-green-700 text-sm text-center mb-1">Create your account for<br /><span className="font-semibold text-green-800">Nisit Deeden Award System</span></p>
        <form onSubmit={handleSubmit} className="w-full mt-4">
          ...
          <button type="submit" className="w-full bg-[#1a7f42] text-white py-2 rounded-lg font-bold mt-2 hover:bg-green-900 transition" disabled={loading}>
            {loading ? "Registering..." : "Register"}
          </button>
        </form>
        <div className="mt-4 text-center text-sm">
          Already have an account? <button onClick={() => navigate('/login')} className="text-[#1a7f42] font-bold underline">Login</button>
        </div>
      </div>
      {/* Footer */}
