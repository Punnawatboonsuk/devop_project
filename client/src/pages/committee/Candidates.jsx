...
const CommitteeCandidates = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-black text-gray-800 mb-2">Live Vote Progress</h1>
      <p className="text-green-700 mb-6">Real-time verification tracking for Nominated Candidates.</p>
